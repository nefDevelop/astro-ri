import type { DARK_MODE, LIGHT_MODE, SYSTEM_MODE, WALLPAPER_BANNER, WALLPAPER_NONE, WALLPAPER_OVERLAY } from "../constants/constants";
...
export type WALLPAPER_MODE = typeof WALLPAPER_BANNER | typeof WALLPAPER_OVERLAY | typeof WALLPAPER_NONE;
...
export type FontItem = {
  ...
  format?: "woff" | "woff2" | "truetype" | "opentype" | "embedded-opentype" | "svg"; // 字体格式，仅当 src 为本地文件时需要
};
