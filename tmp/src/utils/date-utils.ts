...
// Función de formato de fecha internacionalizada
export function formatDateI18n(dateInput: Date | string, includeTime?: boolean): string {
  ...
  // Si se ha configurado una zona horaria, se utiliza para el formato (cadena de zona horaria IANA).
...
// Función de formato de fecha y hora internacionalizada (con horas, minutos y segundos).
