...
/**
 * Elimina las extensiones de archivo (.md, .mdx, .markdown)
 * Se utiliza para convertir el ID de la API de Astro v5 Content Layer en un slug amigable para URL.
 */
...
function joinUrl(...parts: string[]): string {
  const joined = parts.join("/"); // Une las partes de la URL con '/'
